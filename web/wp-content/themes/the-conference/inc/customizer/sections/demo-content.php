...
if ( ! function_exists( 'the_conference_customizer_demo_content' ) ) :
	...
	function the_conference_customizer_demo_content( $wp_customize ) {
		...
		$theme_demo_content_desc = sprintf( '<span class="sticky_info_row"><label class="row-element">%1$s<a href="%2$s" target="_blank">%3$s</a></span><br/><br/>', esc_html__( 'Demo Link : ', 'the-conference' ), esc_url( __( 'https://demo.raratheme.com/the-conference/', 'the-conference' ) ), esc_html__( 'Click here.', 'the-conference' ) );
